          ...
          child: Padding(
            ...
            child: Row(
              children: [
                ...
                BlocBuilder<productScreenViewModel, ProductScreenState>(
                  builder: (context ,state) {
                    return
                      state is AddToCartSuccess?
                      Badge(
                      label: Text("${productScreenViewModel.get(context).numOfCartItems??1 }",    style: TextStyle(color: Colors.white),),
                      child: IconButton(
                          onPressed: () =>
